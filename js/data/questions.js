...
var QUESTION_BANK = [
  ...
  // Q96
  { id: 96, text: "飞机飞行操纵系统的传动机构包括硬式传动机构、软式传动机构和{{1}}等类型。",
    blanks: [{ id: 1, answer: "混合式", alternatives: [] }],
    domain: "操纵系统", difficulty: 1 },
  // Q97
  { id: 97, text: "飞机飞行操纵系统在设计过程中，除过强度、刚度、重量等一般设计要求，所必须的特殊要求为{{1}}。",
    blanks: [{ id: 1, answer: "保证驾驶员能正常操纵飞机", alternatives: [] }],
    domain: "操纵系统", difficulty: 2 },
  // Q98
